...
function SettingsMenu(props) {
  return (
    <Menu noOverlay disableAutoFocus isOpen width={375}>
      <label className="centered large-print">Manual Input Angle Select</label>
      <label
      ...
      >
        ...
        <input
          id="hold-click-checkbox"
          type="checkbox"
          defaultChecked
          onChange={props.handleAngleSelectionChange}
        />
      </label>
      ...
      <label className="centered large-print">Trigonometric Functions</label>
      ...
      <label className="centered large-print">Unit Circle Details</label>
      <div className="centered" style={{ whitespace: 'nowrap' }}>
        <label>
          Axes:
          <input
